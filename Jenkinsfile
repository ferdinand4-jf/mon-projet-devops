pipeline {
    ...
    stages {
        ...
        stage('Arrêt des anciens conteneurs') {
            steps {
                echo '=== ÉTAPE 3 : Nettoyage de l environnement existant ==='
        ...
        stage('Build des Images Docker') {
            steps {
                echo '=== ÉTAPE 4 : Compilation et assemblage des images ==='
        ...
        stage('Déploiement de l Application') {
            steps {
                echo '=== ÉTAPE 5 : Lancement de l infrastructure conteneurisée ==='
